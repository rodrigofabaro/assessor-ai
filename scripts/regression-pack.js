...
const tests = [
  ...
  "scripts/cover-metadata.test.js",
  ...
  "scripts/qa-page-contract.test.js",
  "scripts/brief-grading-scope-change.test.js",
  "scripts/brief-readiness.test.js",
  "scripts/brief-scenario-warning-policy.test.js",
  "scripts/spec-learning-outcome-parser.test.js",
  "scripts/spec-fallback-quality-contract.test.js",
  "scripts/spec-suite-import-transport-contract.test.js",
  ...
  "scripts/org-settings-page-contract.test.js",
  ...
  "scripts/reference-document-delete-lifecycle.test.js",
