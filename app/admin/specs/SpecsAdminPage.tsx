...
export default function SpecsAdminPage() {
  ...
  return (
    ...
    <div className="grid gap-4 min-w-0">
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-700">
              Manage specification issues used as grading ground truth, from extraction through lock-ready approval.
            </p>
          </div>
      ...
      <section className="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm min-w-0">
