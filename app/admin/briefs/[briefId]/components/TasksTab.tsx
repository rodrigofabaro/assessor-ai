...
export function TasksTab({ vm }: { vm: any }) {
  const linkedDoc = vm.linkedDoc;
  const extracted = Array.isArray(linkedDoc?.extractedJson?.tasks) ? linkedDoc.extractedJson.tasks : [];
  const warnings = Array.isArray(linkedDoc?.extractedJson?.warnings) ? linkedDoc.extractedJson.warnings : [];
