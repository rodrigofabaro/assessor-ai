...
- Status (2026-03-09): organization lifecycle coverage added for default-org protection and empty-org-only delete semantics (`scripts/admin-organization-lifecycle-contract.test.js`).
